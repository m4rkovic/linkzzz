  ...
  return (
    <div className="mx-auto flex min-h-[55vh] w-full max-w-2xl items-center justify-center px-2">
      <div className="w-full rounded-3xl border border-red-100 bg-white p-6 text-center shadow-sm sm:p-8">
        ...
        <h1 className="mt-4 text-xl font-black tracking-tight text-zinc-950">This page could not be loaded</h1>
        <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-zinc-500">Your data was not changed. Retry the page; if the problem continues, return to the dashboard and try the action again.</p>
