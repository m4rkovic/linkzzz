      ...
      {draft.imageUrl ? (
        <div className="overflow-hidden rounded-2xl border border-zinc-200">
          ...
          <div className="grid gap-4 p-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2"><Field label="Alt text" optional><input type="text" value={draft.imageAlt} onChange={(event) => onChange({ imageAlt: event.target.value })} className={inputClass} /></Field></div>
          </div>
        </div>
      ) : (
