...
export default function ConfirmDialog({
  ...
  return (
    <DialogShell
      ...
      panelClassName="rounded-t-3xl bg-white p-5 shadow-2xl sm:max-w-md sm:rounded-3xl sm:p-6"
    >
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          <h2 id={titleId} className="text-lg font-black tracking-tight text-zinc-950">
            {title}
          </h2>
          <p id={descriptionId} className="mt-1.5 text-sm leading-6 text-zinc-500">
            {description}
          </p>
        </div>
        <button
